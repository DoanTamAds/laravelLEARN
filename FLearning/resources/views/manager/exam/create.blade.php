                            ...
                            <div class="form-group d-flex justify-content-between w-100">
                                <div class="input-group mb-3 w-25 mr-3 d-flex flex-column">
                                    <label class="" for="name-exam">Nhập tiêu đề bài thi
                                        <input type="text" name="exam_name" class="form-control" id="name-exam" placeholder="Tiêu đề bài thi">
                                    </label>
                                    <label class="d-flex align-items-center" for="number-question">
                                        <input type="number" name="count" class="form-control" id="number-question" placeholder="Số câu hỏi">
                                        <button type="button" class="btn btn-primary js-render">Tạo</button>
                                    </label>
                            ...
                            $('.card-body').append(
                                `
                                 ...
                                 <div class="item mb-5 p-2 border">
                                    ...
                                    <div class="row mb-3">
                                        <label for="" class="col-3 col-form-label">Lựa chọn 4</label>
                                        <div class="col-9">
