                ...
                <form id="form_create_post" method="post"
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-8">
                            ...
                            <input type="text" class="form-control" id="title" name="name" placeholder="Tiêu đề">
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" class="form-control" id="title" name="link1" placeholder="link tài liệu nếu có">
                        </div>
                        <div class="col-4">
                            <label for="title">Link 2</label>
                            <input type="text" class="form-control" id="title" name="link2" placeholder="link tài liệu nếu có">
                        </div>
